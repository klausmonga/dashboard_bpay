...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/charts.svg') ?>" class="svg-icon" alt="">
		<span>Charts</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/charts2.svg') ?>" class="svg-icon" alt="">
		<span>C3 Charts</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/charts3.svg') ?>" class="svg-icon" alt="">
		<span>Echarts</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/reports.svg') ?>" class="svg-icon" alt="">
		<span>Analyses</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/ico.svg') ?>" class="svg-icon" alt="">
		<span>ICO</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/members.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/tickers.svg') ?>" class="svg-icon" alt="">
		<span>Tickers</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/transactions.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/mailbox.svg') ?>" class="svg-icon" alt="">
		<span>Mailbox</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/apps.svg') ?>" class="svg-icon" alt="">
		<span>Apps</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/invoice.svg') ?>" class="svg-icon" alt="">
		<span>Invoice</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/uielements.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/advancedui.svg') ?>" class="svg-icon" alt="">
...
<li>
	<a href="ui_color_utilities.html">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/color.svg') ?>" class="svg-icon" alt="">
		<span>Color</span>
	</a>
</li>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/icons.svg') ?>" class="svg-icon" alt="">
		<span>Icons</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/cards.svg') ?>" class="svg-icon" alt="">
		<span>Cards</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/forms1.svg') ?>" class="svg-icon" alt="">
...
<li>
	<a href="forms_general.html">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/forms2.svg') ?>" class="svg-icon" alt="">
		<span>Form Layout</span>
	</a>
</li>
<li>
	<a href="forms_wizard.html">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/forms3.svg') ?>" class="svg-icon" alt="">
		<span>Form Wizard</span>
	</a>
</li>
<li>
	<a href="forms_validation.html">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/forms4.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/maps.svg') ?>" class="svg-icon" alt="">
		<span>Maps</span>
		<span class="pull-right-container">
			<i class="fa fa-angle-right pull-right"></i>
		</span>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/extensions.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/authentication.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/miscellaneous.svg') ?>" class="svg-icon" alt="">
...
<li>
	<a href="email_index.html">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/emails.svg') ?>" class="svg-icon" alt="">
		<span>Emails</span>
	</a>
</li>
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/pages.svg') ?>" class="svg-icon" alt="">
...
<li class="treeview">
	<a href="#">
		<img src="<?= base_url('assets/images/svg-icon/sidebar-menu/multilevel.svg') ?>" class="svg-icon" alt="">
